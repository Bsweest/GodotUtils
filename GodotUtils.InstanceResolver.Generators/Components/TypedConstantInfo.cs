...
internal abstract partial record TypedConstantInfo
{
    ...
    public sealed record Array(string ElementTypeName, EquatableArray<TypedConstantInfo> Items)
        : TypedConstantInfo
    {
        /// <inheritdoc/>
            ...
            public override ExpressionSyntax GetSyntax()
            {
                return LiteralExpression(
                    ...
                    Value switch
                    {
                        ...
                        double d
                            => Literal(d.ToString("R", CultureInfo.InvariantCulture) + "D", d),
    ...
    public sealed record Enum(string TypeName, object Value) : TypedConstantInfo
    {
        ...
        public override ExpressionSyntax GetSyntax()
        {
            ...
            if (
                valueExpression is PrefixUnaryExpressionSyntax unaryExpression
                && unaryExpression.IsKind(SyntaxKind.UnaryMinusExpression)
            )
            {
